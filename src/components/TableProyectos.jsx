  ...
  return (
    <>
        <tr>
          ...
          <td className="rounded-lg px-4 border-b border-slate-300 p-3"><span className={`${estado === "Finalizado" ? 'bg-green-300 text-green-700 text-bold' : estado === "Progreso" ? 'bg-orange-300 text-orange-700 text-bold' : 'bg-red-300 text-red-700 text-bold' } rounded-lg px-4 py-1 text-xs`}>{estado}</span></td>
