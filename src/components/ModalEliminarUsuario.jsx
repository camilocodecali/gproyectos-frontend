...
const ModalEliminarUsuario = () => {
    const { usuarioApp, cargando, handleModalEliminarUsuario, modalEliminarUsuario, eliminarUsuario } = useUsuario();

  return (
    <Transition.Root show={ modalEliminarUsuario } as={Fragment}>
    <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={ handleModalEliminarUsuario}>
            ...
            >
                    ...
                    <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                        <button
                            ...
                            onClick={handleModalEliminarUsuario}
                        >
                    ...
                    <div className="sm:flex sm:items-center pt-10">
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-center w-full">
                            <Dialog.Title as="h3" className="text-lg leading-6 font-bold text-gray-900">
                                ¿Quieres eliminar el proyecto {usuarioApp.nombre} ?
                            </Dialog.Title>
